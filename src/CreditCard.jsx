...
const CreditCard = ({ name, number, save, year, month, cvc }) => {
  return (
    <div className="bg-[url('./assets/bg-main-mobile.png')] h-64 bg-no-repeat bg-cover max-[320px]:h-56 min-[820px]:bg-[url('./assets/bg-main-desktop.png')] min-[820px]:h-screen">
      <div>
        <img
          src={cardBackground}
          alt="The back of a credit card"
          className="w-3/4 h-2/4 pt-9 translate-x-20 max-[320px]:translate-x-16 min-[414px]:translate-y-2 min-[768px]:w-96"
        />
        <p className="font-bold translate-x-80 -translate-y-24  text-slate-100  max-[320px]:translate-x-60  max-[320px]:-translate-y-20 max-[320px]:text-md min-[360px]:translate-x-[17.5rem] min-[360px]:-translate-y-[5.65rem] min-[412px]:translate-x-[20rem] min-[412px]:-translate-y-[6rem]">
          {save ? cvc : "XXX"}
        </p>
      </div>
      <div>
        ...
        <div className="-translate-y-56 flex flex-col gap-8 max-[320px]:-translate-y-48 max-[320px]:gap-5 max-[360px]:gap-7 max-[360px]:-translate-y-[13.5rem] max-[375px]:-translate-y-[13.6rem] max-[375px]:-translate-x-[.5rem]">
          ...
          <div className="flex flex-col translate-x-9 gap-4 max-[320px]:gap-3 max-[320px]:translate-x-5 min-[360px]:translate-x-7 min-[360px]:gap-2 min-[360px]:translate-y-1">
